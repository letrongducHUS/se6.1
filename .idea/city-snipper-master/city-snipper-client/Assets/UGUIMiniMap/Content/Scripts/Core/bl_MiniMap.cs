...
public class bl_MiniMap : MonoBehaviour
{
    ...
    void Inputs()
    {
        ...
        if (ControlFreak2.CF2Input.GetKeyDown(ToogleKey))
        {
            ToggleSize();
        }
        if (ControlFreak2.CF2Input.GetKeyDown(DecreaseHeightKey) && height < maxHeight)
        {
            ChangeHeight(true);
        }
        if (ControlFreak2.CF2Input.GetKeyDown(IncreaseHeightKey) && height > minHeight)
        {
            ChangeHeight(false);
        }
    }
