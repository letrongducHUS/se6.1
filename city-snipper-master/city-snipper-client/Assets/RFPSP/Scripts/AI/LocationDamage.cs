        ...
        if (AIComponent && AIComponent.CharacterDamageComponent)
        {
            ...
            {//if attack is from player, pass damage info to main CharacterDamage.cs component
                ...
                if (headShot)
                {
                    ...
                    {
                        ScoreScript.instance.HeadShots();
                ...
                if(PlayerPrefs.GetInt("PreviusHeadShots")< Statistics.instance.HeadShots) {Statistics.instance.BodyHitsCount(Statistics.instance.HeadShots-PlayerPrefs.GetInt("PreviusHeadShots")); }
                Statistics.instance.BodyHitsCount(Statistics.instance.HeadShots);
            }
            else
            {//attack is not from player, pass damage info to main CharacterDamage.cs component
